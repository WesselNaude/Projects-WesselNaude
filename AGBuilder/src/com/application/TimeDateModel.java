...
public class TimeDateModel {
	...
	//T3. Declare time date view object. 
	private TimeDateView dateTimeView;
	//T4. Declare integer choice
	private int choice;
	/*T5.Time date model constructor initialises the menu titles, 
    calls class MenuTitles and passes time date model class name to return desired titles. */
	   ...
	   /*T8. Create a new menu adapter passing in home context, 
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
	     ...
	     //T11. Initialise choice variable to arg2, the integer value selected in the list view. 		
				choice = arg2;
		 //T12. If choice == 4, user selected back, return to the initial level of the list view.		
				if (choice == 4){
		  ...
		  /*T13. Passes the choice to text fields view, which then passes choice to, 		
				  text fields factory responsible for constructing the appropriate object. */		
					...
					dateTimeView = new TimeDateView();
					dateTimeView.updateView(choice);
				}
			}
		});
	}
